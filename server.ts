...
import categoryController from "../server/src/controllers/categoryContoller";
    ...
    io.on("connection",(socket)=>{
        ...
        if(token){
          console.log("token",token)
            ...
            jwt.verify(token as string,envConfig.jwtSecreteKey as string, async (err:any,result:any)=>{
                if(err){
